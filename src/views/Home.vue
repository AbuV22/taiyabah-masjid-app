...
const fajrBegTime = computed(
  () => beginingTimes.value.data?.timings?.Fajr || "Loading..."
);
const zohrBegTime = computed(
  () => beginingTimes.value.data?.timings?.Dhuhr || "Loading..."
);
const asrBegTime = computed(
  () => beginingTimes.value.data?.timings?.Asr || "Loading..."
);
const magribBegTime = computed(
  () => beginingTimes.value.data?.timings?.Maghrib || "Loading..."
);
const ishaBegTime = computed(
  () => beginingTimes.value.data?.timings?.Isha || "Loading..."
);
const imsak = computed(
  () => beginingTimes.value.data?.timings?.Imsak || "Loading..."
);
const sunrise = computed(
  () => beginingTimes.value.data?.timings?.Sunrise || "Loading..."
);
const firstThird = computed(
  () => beginingTimes.value.data?.timings?.Firstthird || "Loading..."
);
const lastThird = computed(
  () => beginingTimes.value.data?.timings?.Lastthird || "Loading..."
);
...
<template>
  <div class="prayer-times">
    <div class="prayer-times__center-container">
      ...
      <div>
        <RouterLink class="see-month__router" :to="`/full-month`"
          >See full month</RouterLink
        >
      </div>
